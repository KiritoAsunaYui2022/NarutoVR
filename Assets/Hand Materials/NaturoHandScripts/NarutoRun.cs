...
//THIS IS ALL MESSED UP. MIGHT WANT TO CREATE A NEW SCRIPT 
...
public class NarutoRun : MonoBehaviour
{
    ...
    ////I am 6'3 so the reading system is off because it reads I am 1.75 when in the headset. So just for now I am relying on that number to test the running system. 
